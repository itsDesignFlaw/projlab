...
public class Tester
{
    ...
    static
    {
        ...
        testcases.add(new TestCase("Virologist tries puts virus on a Virologist", "Annak a folyamatnak a modellje, " +
                                                                                  "amikor egy virológus egy másik " +
        ...
        testcases.add(new TestCase("Virologist steals resource", "Lemodellezzük a folyamatot, amelyben a virológus " +
                                                                 "anyagot lop egy másik virológustól.", () ->
        {
            Virologist v = new Virologist();
            Resource r = new Resource();
            Virologist v2 = new Virologist();
